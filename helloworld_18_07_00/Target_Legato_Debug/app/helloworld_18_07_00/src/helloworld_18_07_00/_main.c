...
// Startup code for the executable 'helloworld_18_07_00'.
...
LE_SHARED le_log_SessionRef_t helloworld_18_07_00_exe_LogSession;
LE_SHARED le_log_Level_t* helloworld_18_07_00_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    helloworld_18_07_00_exe_LogSession = log_RegComponent("helloworld_18_07_00_exe", &helloworld_18_07_00_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_helloworld_18_07_00Component.so");
